		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material App",
									"targetURL": "#apmaterialapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apmaterialapp-display": {
								"semanticObject": "apmaterialapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.materialapp",
									"url": sap.ui.require.toUrl("ap/materialapp")
								}
							}
						}
					}
